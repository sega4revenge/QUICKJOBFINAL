...
import za.co.riggaroo.materialhelptutorial.EndPagerIntro;
    ...
    public void loadViewPagerFragments(List<TutorialItem> tutorialItems) {
        ...
        for (int i = 0; i < tutorialItems.size(); i++) {
            if(i<(tutorialItems.size()-1)) {
                ...
                EndPagerIntro endPagerIntro;
                endPagerIntro = EndPagerIntro.newInstance(tutorialItems.get(i), i);
                fragments.add(endPagerIntro);
            }
        }
