...
public class MaterialTutorialActivity extends AppCompatActivity implements MaterialTutorialContract.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        type= intent.getIntExtra("statusIntro",1);
        ...
        mTextViewSkip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mHelpTutorialViewPager.setCurrentItem(mHelpTutorialViewPager.getChildCount()+1);
            }
        });
    ...
    public void setViewPagerFragments(final List<MaterialTutorialFragment> materialTutorialFragments) {
        ...
        final CirclePageIndicator mCirclePageIndicator = (CirclePageIndicator) findViewById(R.id.activity_help_view_page_indicator);
...
//                if(i==(materialTutorialFragments.size()-1)){
//                    mCirclePageIndicator.setStrokeColor(getResources().getColor(R.color.colorBlack));
//                }else{
//                    mCirclePageIndicator.setStrokeColor(getResources().getColor(R.color.colorWhite2));
//                    mCirclePageIndicator.setFillColor(getResources().getColor(R.color.fb));
//                    mCirclePageIndicator.setPageColor(getResources().getColor(R.color.monsoon));
//                }
        ...
        if(type==1){
            mHelpTutorialViewPager.setCurrentItem(materialTutorialFragments.size()-1);
//            mCirclePageIndicator.setStrokeColor(getResources().getColor(R.color.colorWhite2));
//            mCirclePageIndicator.setFillColor(getResources().getColor(R.color.fb));
//            mCirclePageIndicator.setPageColor(getResources().getColor(R.color.monsoon));
        }
