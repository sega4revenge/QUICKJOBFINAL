...
public class TutorialItem implements Parcelable {
    ...
    private int titleTextRes2 = -1;
    private int subTitleTextRes2 = -1;
    ...
    public TutorialItem(@StringRes int titleTextRes, @StringRes int subTitleTextRes,@StringRes int titleTextRes2, @StringRes int subTitleTextRes2, @ColorRes int backgroundColor, @DrawableRes int foregroundImageRes, @DrawableRes int backgroundImageRes) {
        this.titleTextRes = titleTextRes;
        this.subTitleTextRes = subTitleTextRes;
        this.titleTextRes2 = titleTextRes2;
        this.subTitleTextRes2 = subTitleTextRes2;
        this.backgroundColor = backgroundColor;
        this.foregroundImageRes = foregroundImageRes;
        this.backgroundImageRes = backgroundImageRes;
    }
    ...
    public int getTitleTextRes2() {
        return titleTextRes;
    }

    public int getSubTitleTextRes2() {
        return subTitleTextRes;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(this.titleTextRes2);
        dest.writeInt(this.subTitleTextRes2);
    ...
    protected TutorialItem(Parcel in) {
        ...
        this.titleTextRes2 = in.readInt();
        this.subTitleTextRes2 = in.readInt();
