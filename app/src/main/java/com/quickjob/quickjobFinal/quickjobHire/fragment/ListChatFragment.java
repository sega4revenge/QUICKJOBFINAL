...
import com.quickjob.quickjobFinal.quickjobHire.adapter.ListChatAdapter;
...
//    List<Messager_Chat> listdata = new ArrayList<>();
//    List<Messager_Chat> listdata2 = new ArrayList<>();
    List<CompanyInformation> listdata3 = new ArrayList<>();
    DataSnapshot mdataSnapshot;
    LinearLayout linnotfind;ProgressBar pbLoader;
    int CountNumMess=0;
    Firebase rec_list_data,rec_list_child,rec_list_child_company;SessionManager session;String uid,timenewss ;
