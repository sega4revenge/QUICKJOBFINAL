...
public class Create_Job_Activity extends AppCompatActivity {
    ...
    private String age,languages="",skill="",namejob,address_company,infor_company,number_apply,infor_job,pl,request,address_job,namecompany,url,uid,datelimt;
    ...
    private boolean getlogo =false,setimage=false;private Uri filePath;SessionManager session;SharedPreferences.Editor edit;
    @Override
    ...
    private void addView() {
        ...
        ArrayAdapter adaptereducation= ArrayAdapter.createFromResource(Create_Job_Activity.this,R.array.spHocVan,android.R.layout.simple_spinner_item);
        ...
        ArrayAdapter carreradapter= ArrayAdapter.createFromResource(Create_Job_Activity.this, R.array.nganhNghe,android.R.layout.simple_spinner_item);
        carreradapter.setDropDownViewResource(android.R.layout.simple_list_item_checked);
        sp_carrer.setAdapter(carreradapter);
        ArrayAdapter salaryadapter= ArrayAdapter.createFromResource(Create_Job_Activity.this, R.array.mucluong,android.R.layout.simple_spinner_item);
        salaryadapter.setDropDownViewResource(android.R.layout.simple_list_item_checked);
    ...
    private void getIntentData() {
        session = new SessionManager(Create_Job_Activity.this);
        ...
        namecompany = get.getStringExtra("tenct");
        address_company = get.getStringExtra("diachi");
        infor_company = get.getStringExtra("mota");
        url=get.getStringExtra("logo");
        if(url == null || url.equals(""))
        {
                ...
                Glide.with(Create_Job_Activity.this).load(url)
                        .crossFade()
                        .thumbnail(0.5f)
    ...
    {
        final AlertDialog.Builder builder = new AlertDialog.Builder(Create_Job_Activity.this);
        LayoutInflater inflater = (LayoutInflater) Create_Job_Activity.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        final View view = inflater.inflate(R.layout.dialog_createlangues, null);
        ListView lv = (ListView) view.findViewById(R.id.lvnn);
        final String[] ngoaingu = getResources().getStringArray(R.array.spNgoaiNgu2);
        ArrayAdapter ad = ArrayAdapter.createFromResource(Create_Job_Activity.this, R.array.spNgoaiNgu2, android.R.layout.simple_spinner_item);
        lv.setAdapter(ad);
        builder.setTitle(R.string.st_ngoaingu);
        builder.setView(view);
        builder.setPositiveButton(R.string.st_thoat, null);
        final Dialog finalMDialog= builder.create();
        finalMDialog.show();
    ...
    public void onAddSkill(View v) {
        AlertDialog.Builder builder = new AlertDialog.Builder(Create_Job_Activity.this);
        LayoutInflater inflater = (LayoutInflater) Create_Job_Activity.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    ...
    private void setListeners() {
        ...
        mAutoLabellang.setOnRemoveLabelListener(new AutoLabelUI.OnRemoveLabelListener() {
            @Override
            public void onRemoveLabel(com.dpizarro.autolabel.library.Label removedLabel, int position) {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICK_IMAGE_REQUEST && resultCode == Create_Job_Activity.this.RESULT_OK && data != null && data.getData() != null) {
        ...
        if (requestCode == PLACE_PICKER_REQUEST) {
            if (resultCode == RESULT_OK) {
                Place place = PlacePicker.getPlace(Create_Job_Activity.this, data);
                if (place != null) {
    ...
    public void  onDateLimitApply(View v){
        ...
        DatePickerDialog  fromDatePickerDialog = new DatePickerDialog(Create_Job_Activity.this, new DatePickerDialog.OnDateSetListener() {
    ...
    public void onRegister(View v)
    {
        ...
        Log.e("AAAAA", String.valueOf(countlanguage));
        ...
        Log.e("AAAAA", String.valueOf(languages));
...
//        }
        ...
        if (cancel) {
            ...
            if(setimage) {
                ...
                if(getlogo)
                {
                      getData(namejob, "", salary+"", address_job+"", infor_job+"", age+"", education+"", gender+"", languages+"", skill+"", request+"", namecompany+"", "", address_company+"", "", infor_company+"", uid+"",carrer+"", datelimt+"", number_apply+"", pl+"",latitude+"",longitude+"","1");
                }else{
                    Toast.makeText(Create_Job_Activity.this, R.string.st_err_anh, Toast.LENGTH_SHORT).show();
                }
    ...
    private void parseJsonFeed(String result) {
        ...
        if(result.equals("") || result == null){
            Toast.makeText(Create_Job_Activity.this, R.string.st_errServer, Toast.LENGTH_SHORT).show();
            return;
        }
        int jsonResult = returnParsedJsonObject(result);
        if(jsonResult == 0){
            Toast.makeText(Create_Job_Activity.this, R.string.st_errNamePass, Toast.LENGTH_SHORT).show();
            return;
        }
        if(jsonResult == 1){
            Toast.makeText(this,getResources().getString(R.string.st_create_success)+"", Toast.LENGTH_SHORT).show();
            finish();
//            Intent s = new Intent(Create_Job_Activity.this, JobDetailActivity.class);
//            s.putExtra("macv", "");
//            s.putExtra("matd", "");
...
//            finish();
    ...
    private void getData(final String namejop, final String chucdanh, final String mucluong, final String diadiem, final String motacongviec, final String tuoiyeucau,
                         final String hocvan, final String gioitinh, final String ngoaingu, final String kynang, final String yeucaukhac, final String tencongty,
                         final String quymo, final String diachi, final String nganhnghe, final String gioithieucongty, final String uid, final String tennn,
                         final String hannophoso, final String soluong, final String phucloi, final String latitude, final String longitude, final String status) {
        //Getting the unique id generated at firebase
     /*   final String uniqueId = FirebaseInstanceId.getInstance().getToken();*/
        // Tag used to cancel the request
        StringRequest strReq = new StringRequest(Request.Method.POST,
                AppConfig.URL_DANGTIN, new Response.Listener<String>() {
            @Override
    ...
    private void uploadImage(){
        ...
        final ProgressDialog loading = ProgressDialog.show(Create_Job_Activity.this,getString(R.string.st_uploading),getString(R.string.st_plsWait),false,false);
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Create_Job_Activity.this);
    ...
    public void onPickPlaceWork(View v){
        try {
            ...
            startActivityForResult(builder.build(Create_Job_Activity.this), PLACE_PICKER_REQUEST);
