package com.quickjob.quickjobFinal.quickjobHire.pref;
...
import com.quickjob.quickjobFinal.quickjobHire.activity.LoginActivity;
...
public class SessionManager {
    ...
    private static final String PREF_NAME = "JobHirePref";
