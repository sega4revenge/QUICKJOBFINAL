package com.quickjob.quickjobFinal.quickjobHire.other;
...
public class AvatarImageBehavior extends CoordinatorLayout.Behavior<CircleImageView> {
    ...
    private void maybeInitProperties(CircleImageView child, View dependency) {
        ...
        if (mFinalXPosition == 0)
            mFinalXPosition = (mContext.getResources().getDimensionPixelOffset(R.dimen.abc_action_bar_progress_bar_size)) + ((int) mCustomFinalHeight / 2);
