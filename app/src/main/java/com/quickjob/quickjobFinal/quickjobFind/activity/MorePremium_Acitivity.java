...
public class MorePremium_Acitivity extends AppCompatActivity {
    JSONArray mang;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customtv.setText(getResources().getString(R.string.st_morePer) + " " + namecity);
        customtv.setTextSize(12);
        getSupportActionBar().setCustomView(v);
        asyncRequestObject = new AsyncDataClass();
        asyncRequestObject.execute(AppConfig.URL_MOREHOT, beginloadmore + "", namecity, uid);
    ...
    private void addView() {
        ...
        adapter = new ListJobCompanyAdapter(MorePremium_Acitivity.this, celebrities, 2, "", 1);
        recyclerView.setAdapter(adapter);
        final LinearLayoutManager linearLayoutManager = new LinearLayoutManager(MorePremium_Acitivity.this, LinearLayoutManager.VERTICAL, false);
...
//                            dialog = ProgressDialog.show(MorePremium_Acitivity.this, "",
    ...
    private class AsyncDataClass extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.equals("") || result == null) {
                Toast.makeText(MorePremium_Acitivity.this, R.string.st_errServer, Toast.LENGTH_SHORT).show();
//                progressDialog.dismiss();
    ...
    public void intentdetail(List<CongViec> list, int pos) {
        Intent s = new Intent(MorePremium_Acitivity.this, JobDetailActivity.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                Toast.makeText(MorePremium_Acitivity.this, query, Toast.LENGTH_SHORT).show();
                return false;
            }
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                for (CongViec c : celebrities) {
                    if (textlength <= c.tencongviec.length()) {
                        ...
                        //adapter.notifyDataSetChanged();
                        adapter = new ListJobCompanyAdapter(MorePremium_Acitivity.this, tempArrayList, 2, "", 1);
                        recyclerView.setAdapter(adapter);
                    }
                }
