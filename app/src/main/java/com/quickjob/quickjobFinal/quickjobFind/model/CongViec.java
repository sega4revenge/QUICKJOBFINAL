...
//        // TODO Auto-generated method stub
//        dest.writeString(tencongviec);
//        dest.writeString(tecongty);
//        dest.writeString(quymo);
//        dest.writeString(diachict);
//        dest.writeString(ngannghe);
//        dest.writeString(motact);
//        dest.writeString(diadiem);
//        dest.writeString(luong);
//        dest.writeString(dateup);
//        dest.writeString(bangcap);
//        dest.writeString(dotuoi);
//        dest.writeString(ngoaingu);
//        dest.writeString(gioitinh);
//        dest.writeString(khac);
//        dest.writeString(motacv);
//        dest.writeString(kn);
//        dest.writeString(idungtuyen);
//        dest.writeString(statussave);
//        dest.writeString(trangthai);
//        dest.writeString(phucloi);
//        dest.writeString(lat);
//        dest.writeString(lng);
//        dest.writeString(distance);
//        dest.writeString(datecreate);
//        dest.writeString(macv);
//        dest.writeString(url);
//        dest.writeString(nganhnghe);
//        dest.writeString(chucdanh);
//        dest.writeString(soluong);
//        dest.writeString(matd);
//        dest.writeString(views);
//    }
//
//    public CongViec(Parcel in) {
//       tencongviec=in.readString();
//       tecongty=in.readString();
//       quymo=in.readString();
//       diachict=in.readString();
//       ngannghe=in.readString();
//       motact=in.readString();
//       diadiem=in.readString();
//       luong=in.readString();
//       dateup=in.readString();
//       bangcap=in.readString();
//       dotuoi=in.readString();
//       ngoaingu=in.readString();
//       gioitinh=in.readString();
//       khac=in.readString();
//       motacv=in.readString();
//       kn=in.readString();
//       idungtuyen=in.readString();
//       statussave=in.readString();
//       trangthai=in.readString();
//       phucloi=in.readString();
//       lat=in.readString();
//       lng=in.readString();
...
//    }
//
//    public static final Parcelable.Creator<CongViec> CREATOR = new Parcelable.Creator<CongViec>() {
//        public CongViec createFromParcel(Parcel in) {
//            return new CongViec(in);
//        }
//
//        public CongViec[] newArray(int size) {
//            return new CongViec[size];
//        }
//    };
}
