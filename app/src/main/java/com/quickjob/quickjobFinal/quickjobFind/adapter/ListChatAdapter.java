...
import com.quickjob.quickjobFinal.quickjobFind.activity.ChattingActivity;
...
public class ListChatAdapter extends RecyclerView.Adapter<ListChatAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            ...
            divide=(View) view.findViewById(R.id.divide);
    ...
    public void onBindViewHolder(final ListChatAdapter.MyViewHolder holder, int position) {
        ...
        final CompanyInformation job = myArray.get(position);
            holder.name.setText(job.getNamecompany());
            holder.time.setText("");
        ...
        if(job.getLogo().equals("") || job.getLogo()==null)
        {
            holder.avata.setImageResource(R.drawable.logo2);
        }else {
            Glide.with(getApplicationContext()).load(job.getLogo())
                    .crossFade()
                    .thumbnail(0.5f)
            ...
            holder.lin.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View view) {
                    new SweetAlertDialog(mContext, SweetAlertDialog.WARNING_TYPE)
                            .setTitleText(mContext.getResources().getString(R.string.st_deleteprofile))
           ...
           holder.lin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                i.putExtra("logocompany",job.getLogo());
                i.putExtra("avata",avata);
                i.putExtra("namecompany",job.getNamecompany());
                i.putExtra("idcompany",job.getUid());
