...
public class IntroActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK && requestCode == REQUEST_CODE) {
            ...
            startActivity(new Intent(IntroActivity.this, com.quickjob.quickjobFinal.quickjobFind.activity.LoginActivity.class));
            finish();
        }else{
            prefManager.setFirstTimeLaunch(true);
            startActivity(new Intent(IntroActivity.this, com.quickjob.quickjobFinal.quickjobHire.activity.LoginActivity.class));
            finish();
        }
    }
